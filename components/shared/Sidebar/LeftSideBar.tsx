...
const LeftSideBar = () => {
  ...
  return (
    <section className="left-side-bar max-sm:hidden background-light900_dark200 pt-36 p-6 flex flex-col h-screen justify-between custom-scrollbar  shadow-light-300 dark:shadow-none sticky left-0 top-0 lg:w-[266px]">
